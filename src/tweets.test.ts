import { loggedInScraperTest, anonymousScraperTest } from './test-utils';
import { Mention, Tweet } from './tweets';
import { QueryTweetsResponse } from './timeline-v1';
import { Scraper } from './scraper';

anonymousScraperTest('scraper can get tweet', async (scraper: Scraper) => {
...
anonymousScraperTest(
  'scraper can get tweets without logging in',
...
loggedInScraperTest(
  'scraper can get tweets from list',
  async (scraper: Scraper) => {
...
anonymousScraperTest(
  'scraper can get first tweet matching query',
  async (scraper: Scraper) => {
...
anonymousScraperTest(
  'scraper can get all tweets matching query',
  async (scraper: Scraper) => {
...
anonymousScraperTest(
  'scraper can get user mentions in tweets',
  async (scraper: Scraper) => {
...
anonymousScraperTest(
  'scraper can get tweet quotes without logging in',
  async (scraper: Scraper) => {
    const expected: Tweet = {
...
loggedInScraperTest(
  'scraper can get tweet quotes and replies',
  async (scraper: Scraper) => {
    const expected: Tweet = {
      conversationId: '1237110546383724547',
      html: `The Easiest Problem Everyone Gets Wrong <br><br>[new video] --&gt; <a href=\"https://youtu.be/ytfCdqWhmdg\">https://t.co/YdaeDYmPAU</a> <br><a href=\"https://t.co/iKu4Xs6o2V\"><img src=\"https://pbs.twimg.com/media/ESsZa9AXgAIAYnF.jpg\"/></a>`,
...
anonymousScraperTest('scraper can get retweet', async (scraper: Scraper) => {
  const expected: Tweet = {
